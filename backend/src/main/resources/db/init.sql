...
VALUES
    ...
    (3201, 'sys', NULL, '系统交互', '系统交互相关意图域', 'system', 1, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 20, 20, 0),
    (3202, 'sys-welcome', 'sys', '欢迎与问候', '用户与助手打招呼，如你好、hello、在吗等', 'system', 1, NULL, 1, '["你好","hello","在吗"]', NULL, NULL, NULL, NULL, NULL, NULL, 1, 21, 21, 0),
    (3203, 'sys-about-bot', 'sys', '关于助手', '询问助手是做什么的、是谁、能做什么等', 'system', 1, NULL, 1, '["你是谁","你能帮我做什么","你是什么AI"]', NULL, NULL, NULL, NULL, NULL, NULL, 1, 22, 22, 0),
    (3301, 'sales', NULL, '销售汇总数据统计', 'MCP 实时销售数据查询域', 'mcp', 2, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 30, 30, 0),
    (3302, 'sales-data', 'sales', '销售数据统计', '销售总额、销售量、销售占比、趋势等实时统计', 'mcp', 2, NULL, 1, '["销售总额是多少？","销售量是多少？"]', NULL, NULL, NULL, 'sales_query', '请提取销售统计查询参数', NULL, 1, 31, 31, 0)
ON CONFLICT (id) DO UPDATE
SET
