...
INSERT INTO chat_intent_node (id, intent_code, parent_code, name, description, intent_type, prompt_template, mcp_tool_id, param_prompt_template, enabled, sort_no, deleted)
VALUES
    (3001, 'group', NULL, '集团信息化', '集团信息化相关知识域', 'kb', NULL, NULL, NULL, 1, 1, 0),
    (3002, 'group-hr', 'group', '人事', '招聘、入职、转正、离职、绩效、薪资、考勤、请假等人力资源相关问题', 'kb', NULL, NULL, NULL, 1, 2, 0),
    (3003, 'group-it', 'group', 'IT支持', 'VPN、邮箱、打印机、网络、电脑账号密码、办公软件等 IT 支持相关问题', 'kb', NULL, NULL, NULL, 1, 3, 0),
    (3004, 'group-finance', 'group', '财务', '报销、付款、成本中心、预算等财务相关问题', 'kb', NULL, NULL, NULL, 1, 4, 0),
    (3005, 'group-finance-invoice', 'group-finance', '发票相关', '获取公司发票抬头相关信息', 'kb', NULL, NULL, NULL, 1, 5, 0),
    (3101, 'biz', NULL, '业务系统', '业务系统相关知识域', 'kb', NULL, NULL, NULL, 1, 10, 0),
    (3102, 'biz-oa', 'biz', 'OA系统', 'OA 系统相关，例如流程审批、待办、公告、文档中心等', 'kb', NULL, NULL, NULL, 1, 11, 0),
    (3103, 'biz-oa-intro', 'biz-oa', '系统介绍', 'OA 系统整体功能说明、主要模块、典型使用场景', 'kb', NULL, NULL, NULL, 1, 12, 0),
    (3104, 'biz-oa-security', 'biz-oa', '数据安全', 'OA系统的数据权限、访问控制、安全审计等相关说明', 'kb', NULL, NULL, NULL, 1, 13, 0),
    (3105, 'biz-ins', 'biz', '保险系统', '保险相关业务系统，如投保、核保、理赔等的功能与架构说明', 'kb', NULL, NULL, NULL, 1, 14, 0),
    (3106, 'biz-ins-intro', 'biz-ins', '系统介绍', '保险系统业务模块说明与主要流程介绍', 'kb', NULL, NULL, NULL, 1, 15, 0),
    (3107, 'biz-ins-arch', 'biz-ins', '架构设计', '保险系统的技术架构、服务拆分、数据库设计等', 'kb', NULL, NULL, NULL, 1, 16, 0),
    (3108, 'biz-ins-security', 'biz-ins', '数据安全', '保险系统的数据脱敏、权限控制、审计与合规等', 'kb', NULL, NULL, NULL, 1, 17, 0),
    (3201, 'sys', NULL, '系统交互', '系统交互相关意图域', 'system', NULL, NULL, NULL, 1, 20, 0),
    (3202, 'sys-welcome', 'sys', '欢迎与问候', '用户与助手打招呼，如你好、hello、在吗等', 'system', NULL, NULL, NULL, 1, 21, 0),
    (3203, 'sys-about-bot', 'sys', '关于助手', '询问助手是做什么的、是谁、能做什么等', 'system', NULL, NULL, NULL, 1, 22, 0),
    (3301, 'sales', NULL, '销售汇总数据统计', 'MCP 实时销售数据查询域', 'mcp', NULL, NULL, NULL, 1, 30, 0),
    (3302, 'sales-data', 'sales', '销售数据统计', '销售总额、销售量、销售占比、趋势等实时统计', 'mcp', NULL, 'sales_query', '请提取销售统计查询参数', 1, 31, 0)
ON CONFLICT (id) DO UPDATE
SET
