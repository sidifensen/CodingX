...
var init_server$1 = require_chunk.__esmMin((() => {
...
var Server;
var init_server = require_chunk.__esmMin((() => {
	require_helpers.init_protocol();
	require_types.init_types();
	require_helpers.init_ajv_provider();
	require_helpers.init_zod_compat();
	init_server$1();
	require_helpers.init_helpers();
	Server = class extends require_helpers.Protocol {
		/**
		...
		*/
		constructor(_serverInfo, options) {
			...
			this._jsonSchemaValidator = (_b = options === null || options === void 0 ? void 0 : options.jsonSchemaValidator) !== null && _b !== void 0 ? _b : new require_helpers.AjvJsonSchemaValidator();
			this.setRequestHandler(require_types.InitializeRequestSchema, (request) => this._oninitialize(request));
			this.setNotificationHandler(require_types.InitializedNotificationSchema, () => {
				var _a;
			...
			if (this._capabilities.logging) this.setRequestHandler(require_types.SetLevelRequestSchema, async (request, extra) => {
				var _a;
				const transportSessionId = extra.sessionId || ((_a = extra.requestInfo) === null || _a === void 0 ? void 0 : _a.headers["mcp-session-id"]) || void 0;
		...
		*/
		setRequestHandler(requestSchema, handler) {
			var _a, _b, _c;
			const shape = require_helpers.getObjectShape(requestSchema);
		...
		assertTaskCapability(method) {
			var _a, _b;
			require_helpers.assertClientRequestTaskCapability((_b = (_a = this._clientCapabilities) === null || _a === void 0 ? void 0 : _a.tasks) === null || _b === void 0 ? void 0 : _b.requests, method, "Client");
		}
		assertTaskHandlerCapability(method) {
			var _a;
			if (!this._capabilities) return;
			require_helpers.assertToolsCallTaskCapability((_a = this._capabilities.tasks) === null || _a === void 0 ? void 0 : _a.requests, method, "Server");
		}
...
var init_completable = require_chunk.__esmMin((() => {
...
var TOOL_NAME_REGEX;
var init_toolNameValidation = require_chunk.__esmMin((() => {
...
var init_mcp_server = require_chunk.__esmMin((() => {
...
require_chunk.__esmMin((() => {
	init_server();
	require_helpers.init_zod_compat();
	require_helpers.init_zod_json_schema_compat();
	require_types.init_types();
	init_completable();
	...
	McpServer = class {
		...
		*/
		async validateToolInput(tool, args, toolName) {
			...
			const inputObj = require_helpers.normalizeObjectSchema(tool.inputSchema);
			const parseResult = await require_helpers.safeParseAsync(inputObj !== null && inputObj !== void 0 ? inputObj : tool.inputSchema, args);
		...
		*/
		...
		async handlePromptCompletion(request, ref) {
			...
			const promptShape = require_helpers.getObjectShape(prompt.argsSchema);
	...
	EMPTY_COMPLETION_RESULT = { completion: {
		values: [],
		hasMore: false
	} };
}))();
