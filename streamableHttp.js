...
* MIT Licensed
*/
var require_bytes = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module exports.
	* @public
	*/
...
var require_depd = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/*!
	* depd
...
var require_setprototypeof = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
...
var codes_exports = /* @__PURE__ */ require_chunk.__exportAll({ default: () => codes_default });
var codes_default;
var init_codes = require_chunk.__esmMin((() => {
	codes_default = {
		"100": "Continue",
...
* MIT Licensed
*/
var require_statuses = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module dependencies.
	* @private
	*/
	var codes = (init_codes(), require_chunk.__toCommonJS(codes_exports).default);
	/**
	* Module exports.
	* @public
	*/
...
* MIT Licensed
*/
var require_toidentifier = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module exports.
	* @public
	*/
...
* MIT Licensed
*/
var require_http_errors = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module dependencies.
	* @private
	*/
	...
	var inherits = require_safer$1.require_inherits();
...
* MIT Licensed
*/
var require_unpipe = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module exports.
	* @public
	*/
...
* MIT Licensed
*/
var require_raw_body = /* @__PURE__ */ require_chunk.__commonJSMin(((exports, module) => {
	/**
	* Module dependencies.
	* @private
	*/
...
var import_raw_body, import_content_type, MAXIMUM_MESSAGE_SIZE, StreamableHTTPServerTransport;
//#endregion
require_chunk.__esmMin((() => {
	require_types.init_types();
	import_raw_body = /* @__PURE__ */ require_chunk.__toESM(require_raw_body(), 1);
	import_content_type = /* @__PURE__ */ require_chunk.__toESM(require_content_type(), 1);
	...
	StreamableHTTPServerTransport = class {
			...
			try {
				...
				const replayedStreamId = await this._eventStore.replayEventsAfter(lastEventId, { send: async (eventId, message) => {
					...
					if (!this.writeSSEEvent(res, message, eventId)) {
						(_a = this.onerror) === null || _a === void 0 || _a.call(this, /* @__PURE__ */ new Error("Failed replay events"));
						res.end();
					}
				} });
		...
		*/
		async handlePostRequest(req, res, parsedBody) {
			...
			try {
				...
				const hasRequests = messages.some(require_types.isJSONRPCRequest);
				if (!hasRequests) {
					...
					const streamId = (0, node_crypto.randomUUID)();
					const initRequest = messages.find((m) => require_types.isInitializeRequest(m));
					const clientProtocolVersion = initRequest ? initRequest.params.protocolVersion : (_d = req.headers["mcp-protocol-version"]) !== null && _d !== void 0 ? _d : require_types.DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
				...
				(_f = this.onerror) === null || _f === void 0 || _f.call(this, error);
			}
		}
		/**
		...
		*/
		...
		validateProtocolVersion(req, res) {
			var _a;
			let protocolVersion = (_a = req.headers["mcp-protocol-version"]) !== null && _a !== void 0 ? _a : require_types.DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
			if (Array.isArray(protocolVersion)) protocolVersion = protocolVersion[protocolVersion.length - 1];
			if (!require_types.SUPPORTED_PROTOCOL_VERSIONS.includes(protocolVersion)) {
				res.writeHead(400).end(JSON.stringify({
					jsonrpc: "2.0",
					error: {
						code: -32e3,
						message: `Bad Request: Unsupported protocol version (supported versions: ${require_types.SUPPORTED_PROTOCOL_VERSIONS.join(", ")})`
					},
					id: null
				}));
				return false;
		...
		*/
		...
		async send(message, options) {
			...
			if (require_types.isJSONRPCResponse(message) || require_types.isJSONRPCError(message)) requestId = message.id;
			if (requestId === void 0) {
				if (require_types.isJSONRPCResponse(message) || require_types.isJSONRPCError(message)) throw new Error("Cannot send a response on a standalone SSE stream unless resuming a previous client request");
				let eventId;
			...
			if (require_types.isJSONRPCResponse(message) || require_types.isJSONRPCError(message)) {
