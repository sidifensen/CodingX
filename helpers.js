...
var util$1, objectUtil$1, ZodParsedType$1, getParsedType$1;
var init_util$1 = require_chunk.__esmMin((() => {
	(function(util) {
		util.assertEqual = (_) => {};
	...
	ZodParsedType$1 = util$1.arrayToEnum([
		"string",
		"nan",
		"number",
		"integer",
...
var ZodIssueCode$1, ZodError$1;
var init_ZodError$1 = require_chunk.__esmMin((() => {
	init_util$1();
	...
	ZodError$1 = class ZodError$1 extends Error {
		get errors() {
			return this.issues;
		}
		constructor(issues) {
...
var errorMap$1;
var init_en$1 = require_chunk.__esmMin((() => {
	init_ZodError$1();
	init_util$1();
...
var overrideErrorMap$1;
var init_errors$1 = require_chunk.__esmMin((() => {
	init_en$1();
	overrideErrorMap$1 = errorMap$1;
}));
//#endregion
...
var makeIssue$1, ParseStatus$1, INVALID$1, DIRTY$1, OK$1, isAborted$1, isDirty$1, isValid$1, isAsync$1;
var init_parseUtil$1 = require_chunk.__esmMin((() => {
	init_errors$1();
	init_en$1();
	makeIssue$1 = (params) => {
	...
	ParseStatus$1 = class ParseStatus$1 {
		constructor() {
			this.value = "valid";
		}
		dirty() {
	...
	INVALID$1 = Object.freeze({ status: "aborted" });
	DIRTY$1 = (value) => ({
		status: "dirty",
		value
	});
	...
	isDirty$1 = (x) => x.status === "dirty";
	isValid$1 = (x) => x.status === "valid";
	isAsync$1 = (x) => typeof Promise !== "undefined" && x instanceof Promise;
}));
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/helpers/typeAliases.js
var init_typeAliases$1 = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/helpers/errorUtil.js
var errorUtil$1;
var init_errorUtil$1 = require_chunk.__esmMin((() => {
	(function(errorUtil) {
...
var ParseInputLazyPath$1, handleResult$1, ZodType$1, cuidRegex$1, cuid2Regex$1, ulidRegex$1, uuidRegex$1, nanoidRegex$1, jwtRegex$1, durationRegex$1, emailRegex$1, _emojiRegex$1, emojiRegex$2, ipv4Regex$1, ipv4CidrRegex$1, ipv6Regex$1, ipv6CidrRegex$1, base64Regex$1, base64urlRegex$1, dateRegexSource$1, dateRegex$1, ZodString$1, ZodNumber$1, ZodBigInt$1, ZodBoolean$1, ZodDate$1, ZodSymbol$1, ZodUndefined$1, ZodNull$1, ZodAny$1, ZodUnknown$1, ZodNever$1, ZodVoid$1, ZodArray$1, ZodObject$1, ZodUnion$1, getDiscriminator$1, ZodDiscriminatedUnion$1, ZodIntersection$1, ZodTuple$1, ZodRecord$1, ZodMap$1, ZodSet$1, ZodFunction$1, ZodLazy$1, ZodLiteral$1, ZodEnum$1, ZodNativeEnum$1, ZodPromise$1, ZodEffects$1, ZodOptional$1, ZodNullable$1, ZodDefault$1, ZodCatch$1, ZodNaN$1, ZodBranded$1, ZodPipeline$1, ZodReadonly$1, ZodFirstPartyTypeKind$1, objectType$1;
var init_types$1 = require_chunk.__esmMin((() => {
	init_ZodError$1();
	init_errors$1();
	init_errorUtil$1();
	init_parseUtil$1();
	init_util$1();
	ParseInputLazyPath$1 = class {
	...
	cuidRegex$1 = /^c[^\s-]{8,}$/i;
	cuid2Regex$1 = /^[0-9a-z]+$/;
	ulidRegex$1 = /^[0-9A-HJKMNP-TV-Z]{26}$/i;
	uuidRegex$1 = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i;
	nanoidRegex$1 = /^[a-z0-9_-]{21}$/i;
	jwtRegex$1 = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/;
	durationRegex$1 = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/;
	emailRegex$1 = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i;
	_emojiRegex$1 = `^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$`;
	ipv4Regex$1 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/;
	ipv4CidrRegex$1 = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/;
	ipv6Regex$1 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/;
	ipv6CidrRegex$1 = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/;
	base64Regex$1 = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/;
	base64urlRegex$1 = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/;
	dateRegexSource$1 = `((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))`;
	dateRegex$1 = new RegExp(`^${dateRegexSource$1}$`);
	ZodString$1 = class ZodString$1 extends ZodType$1 {
		_parse(input) {
	...
	ZodNumber$1 = class ZodNumber$1 extends ZodType$1 {
		constructor() {
			super(...arguments);
			this.min = this.gte;
			this.max = this.lte;
	...
	ZodBigInt$1 = class ZodBigInt$1 extends ZodType$1 {
		constructor() {
			super(...arguments);
			this.min = this.gte;
			this.max = this.lte;
	...
	ZodBoolean$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodDate$1 = class ZodDate$1 extends ZodType$1 {
		_parse(input) {
	...
	ZodSymbol$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodUndefined$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodNull$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodAny$1 = class extends ZodType$1 {
		constructor() {
			super(...arguments);
			this._any = true;
		}
	...
	ZodUnknown$1 = class extends ZodType$1 {
		constructor() {
			super(...arguments);
			this._unknown = true;
		}
	...
	ZodNever$1 = class extends ZodType$1 {
		_parse(input) {
			const ctx = this._getOrReturnCtx(input);
			addIssueToContext$1(ctx, {
				code: ZodIssueCode$1.invalid_type,
	...
	ZodVoid$1 = class extends ZodType$1 {
		_parse(input) {
			if (this._getType(input) !== ZodParsedType$1.undefined) {
				const ctx = this._getOrReturnCtx(input);
				addIssueToContext$1(ctx, {
	...
	ZodArray$1 = class ZodArray$1 extends ZodType$1 {
		_parse(input) {
	...
	ZodObject$1 = class ZodObject$1 extends ZodType$1 {
		constructor() {
			super(...arguments);
			this._cached = null;
			/**
	...
	ZodUnion$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodDiscriminatedUnion$1 = class ZodDiscriminatedUnion$1 extends ZodType$1 {
		_parse(input) {
			const { ctx } = this._processInputParams(input);
	...
	ZodIntersection$1 = class extends ZodType$1 {
		_parse(input) {
			const { status, ctx } = this._processInputParams(input);
	...
	ZodTuple$1 = class ZodTuple$1 extends ZodType$1 {
		_parse(input) {
			const { status, ctx } = this._processInputParams(input);
			if (ctx.parsedType !== ZodParsedType$1.array) {
				addIssueToContext$1(ctx, {
	...
	ZodRecord$1 = class ZodRecord$1 extends ZodType$1 {
		get keySchema() {
	...
	ZodSet$1 = class ZodSet$1 extends ZodType$1 {
		_parse(input) {
			const { status, ctx } = this._processInputParams(input);
	...
	ZodFunction$1 = class ZodFunction$1 extends ZodType$1 {
		constructor() {
			super(...arguments);
	...
	ZodLiteral$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodEnum$1 = class ZodEnum$1 extends ZodType$1 {
		_parse(input) {
	...
	ZodNativeEnum$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodPromise$1 = class extends ZodType$1 {
		unwrap() {
			return this._def.type;
		}
		_parse(input) {
	...
	ZodEffects$1 = class extends ZodType$1 {
		innerType() {
	...
	ZodOptional$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodNullable$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodDefault$1 = class extends ZodType$1 {
		_parse(input) {
			const { ctx } = this._processInputParams(input);
			let data = ctx.data;
	...
	ZodCatch$1 = class extends ZodType$1 {
		_parse(input) {
			const { ctx } = this._processInputParams(input);
			const newCtx = {
				...ctx,
	...
	ZodNaN$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodBranded$1 = class extends ZodType$1 {
		_parse(input) {
			const { ctx } = this._processInputParams(input);
			const data = ctx.data;
	...
	ZodPipeline$1 = class ZodPipeline$1 extends ZodType$1 {
		_parse(input) {
			const { status, ctx } = this._processInputParams(input);
			if (ctx.common.async) {
	...
	ZodReadonly$1 = class extends ZodType$1 {
		_parse(input) {
	...
	ZodVoid$1.create;
	ZodArray$1.create;
	objectType$1 = ZodObject$1.create;
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/external.js
var init_external$2 = require_chunk.__esmMin((() => {
	init_errors$1();
	init_parseUtil$1();
	init_typeAliases$1();
	init_util$1();
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v3/index.js
var init_v3$1 = require_chunk.__esmMin((() => {
	init_external$2();
}));
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4/mini/parse.js
var init_parse = require_chunk.__esmMin((() => {
	require_types$1.init_core();
}));
//#endregion
...
var init_schemas = require_chunk.__esmMin((() => {
	require_types$1.init_core();
	require_types$1.init_util();
	init_parse();
	ZodMiniType = /* @__PURE__ */ require_types$1.$constructor("ZodMiniType", (inst, def) => {
	...
	ZodMiniObject = /* @__PURE__ */ require_types$1.$constructor("ZodMiniObject", (inst, def) => {
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4/mini/checks.js
var init_checks = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4/mini/external.js
var init_external$1 = require_chunk.__esmMin((() => {
	init_parse();
	init_schemas();
	init_checks();
	init_schemas();
...
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4/mini/index.js
var init_mini = require_chunk.__esmMin((() => {
	init_external$1();
}));
//#endregion
//#region ../../node_modules/@modelcontextprotocol/sdk/node_modules/zod/v4-mini/index.js
var init_v4_mini = require_chunk.__esmMin((() => {
	init_mini();
}));
//#endregion
...
function objectFromShape(shape) {
	...
	if (allV3) return objectType$1(shape);
...
function normalizeObjectSchema(schema) {
	...
	if (isZ4Schema(schema)) {
		const def = (_a = schema._zod) === null || _a === void 0 ? void 0 : _a.def;
...
function getSchemaDescription(schema) {
	var _a, _b, _c, _d;
	if (isZ4Schema(schema)) return (_b = (_a = schema._zod) === null || _a === void 0 ? void 0 : _a.def) === null || _b === void 0 ? void 0 : _b.description;
...
function isSchemaOptional(schema) {
	var _a, _b, _c;
	if (isZ4Schema(schema)) return ((_b = (_a = schema._zod) === null || _a === void 0 ? void 0 : _a.def) === null || _b === void 0 ? void 0 : _b.type) === "optional";
	const v3Schema = schema;
...
var init_zod_compat = require_chunk.__esmMin((() => {
	init_v3$1();
	init_v4_mini();
}));
//#endregion
...
var getRefs;
var init_Refs = require_chunk.__esmMin((() => {
	init_Options();
	getRefs = (options) => {
...
var init_errorMessages = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/zod-to-json-schema/dist/esm/getRelativePath.js
var getRelativePath;
var init_getRelativePath = require_chunk.__esmMin((() => {
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/helpers/util.js
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/ZodError.js
var ZodIssueCode, ZodError;
var init_ZodError = require_chunk.__esmMin((() => {
	init_util();
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/locales/en.js
var errorMap;
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/errors.js
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/helpers/parseUtil.js
...
var init_parseUtil = require_chunk.__esmMin((() => {
	init_errors();
	init_en();
	makeIssue = (params) => {
		const { data, path, errorMaps, issueData } = params;
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/helpers/typeAliases.js
var init_typeAliases = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/helpers/errorUtil.js
var errorUtil;
var init_errorUtil = require_chunk.__esmMin((() => {
	(function(errorUtil) {
		errorUtil.errToObj = (message) => typeof message === "string" ? { message } : message || {};
		errorUtil.toString = (message) => typeof message === "string" ? message : message?.message;
	})(errorUtil || (errorUtil = {}));
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/types.js
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/external.js
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/node_modules/zod/v3/index.js
var init_v3 = require_chunk.__esmMin((() => {
	init_external();
}));
//#endregion
...
var init_any = require_chunk.__esmMin((() => {
...
var init_array = require_chunk.__esmMin((() => {
	init_v3();
	init_errorMessages();
	init_parseDef();
}));
...
var init_bigint = require_chunk.__esmMin((() => {
	init_errorMessages();
}));
//#endregion
...
var init_date = require_chunk.__esmMin((() => {
	init_errorMessages();
...
var init_default = require_chunk.__esmMin((() => {
	init_parseDef();
}));
//#endregion
...
var init_effects = require_chunk.__esmMin((() => {
	init_parseDef();
	init_any();
}));
//#endregion
...
var init_enum = require_chunk.__esmMin((() => {}));
//#endregion
...
var init_intersection = require_chunk.__esmMin((() => {
	init_parseDef();
...
var init_literal = require_chunk.__esmMin((() => {}));
//#endregion
...
var init_string = require_chunk.__esmMin((() => {
	init_errorMessages();
	emojiRegex = void 0;
	zodPatterns = {
		cuid: /^[cC][^\s-]{8,}$/,
...
var init_record = require_chunk.__esmMin((() => {
	init_v3();
	init_parseDef();
	init_string();
	init_branded();
...
var init_map = require_chunk.__esmMin((() => {
	init_parseDef();
	init_record();
	init_any();
}));
...
var init_nativeEnum = require_chunk.__esmMin((() => {}));
//#endregion
...
var init_never = require_chunk.__esmMin((() => {
	init_any();
}));
//#endregion
...
var init_null = require_chunk.__esmMin((() => {}));
//#endregion
...
var init_union = require_chunk.__esmMin((() => {
	init_parseDef();
	primitiveMappings = {
		ZodString: "string",
		ZodNumber: "number",
...
var init_nullable = require_chunk.__esmMin((() => {
	init_parseDef();
	init_union();
}));
//#endregion
...
var init_number = require_chunk.__esmMin((() => {
	init_errorMessages();
}));
//#endregion
...
var init_pipeline = require_chunk.__esmMin((() => {
	init_parseDef();
...
var init_promise = require_chunk.__esmMin((() => {
	init_parseDef();
}));
//#endregion
...
var init_set = require_chunk.__esmMin((() => {
	init_errorMessages();
	init_parseDef();
}));
//#endregion
...
var init_tuple = require_chunk.__esmMin((() => {
	init_parseDef();
}));
//#endregion
...
var init_undefined = require_chunk.__esmMin((() => {
	init_any();
}));
//#endregion
...
var selectParser;
var init_selectParser = require_chunk.__esmMin((() => {
	init_v3();
	init_any();
	init_array();
	init_bigint();
...
var get$ref, addMeta;
var init_parseDef = require_chunk.__esmMin((() => {
	init_Options();
	init_selectParser();
	init_getRelativePath();
	init_any();
...
//#endregion
//#region ../../node_modules/zod-to-json-schema/dist/esm/parseTypes.js
var init_parseTypes = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/zod-to-json-schema/dist/esm/zodToJsonSchema.js
var zodToJsonSchema;
var init_zodToJsonSchema = require_chunk.__esmMin((() => {
	init_parseDef();
	init_Refs();
	init_any();
...
var init_zod_json_schema_compat = require_chunk.__esmMin((() => {
	init_v4_mini();
	init_zod_compat();
	init_esm();
}));
		...
		*/
		async connect(transport) {
			...
			this._transport.onmessage = (message, extra) => {
				...
				if (require_types$1.isJSONRPCResponse(message) || require_types$1.isJSONRPCError(message)) this._onresponse(message);
		...
		_onrequest(request, extra) {
			...
			const relatedTaskId = (_d = (_c = (_b = request.params) === null || _b === void 0 ? void 0 : _b._meta) === null || _c === void 0 ? void 0 : _c["io.modelcontextprotocol/related-task"]) === null || _d === void 0 ? void 0 : _d.taskId;
			if (handler === void 0) {
				const errorResponse = {
					jsonrpc: "2.0",
					id: request.id,
				...
				if (relatedTaskId && this._taskMessageQueue) this._enqueueTaskMessage(relatedTaskId, {
					...
					timestamp: Date.now()
				}, capturedTransport === null || capturedTransport === void 0 ? void 0 : capturedTransport.sessionId).catch((error) => this._onerror(/* @__PURE__ */ new Error(`Failed to enqueue error response: ${error}`)));
				else capturedTransport === null || capturedTransport === void 0 || capturedTransport.send(errorResponse).catch((error) => this._onerror(/* @__PURE__ */ new Error(`Failed to send an error response: ${error}`)));
				return;
			}
		...
		_onresponse(response) {
			...
			if (resolver) {
				...
				if (require_types$1.isJSONRPCResponse(response)) resolver(response);
			...
			if (require_types$1.isJSONRPCResponse(response) && response.result && typeof response.result === "object") {
			...
			if (require_types$1.isJSONRPCResponse(response)) handler(response);
		...
		async *requestStream(request, resultSchema, options) {
			...
			try {
				...
				while (true) {
					...
					const pollInterval = (_c = (_a = task.pollInterval) !== null && _a !== void 0 ? _a : (_b = this._options) === null || _b === void 0 ? void 0 : _b.defaultTaskPollInterval) !== null && _c !== void 0 ? _c : 1e3;
		...
		async notification(notification, options) {
			...
			if (((_d = (_c = this._options) === null || _c === void 0 ? void 0 : _c.debouncedNotificationMethods) !== null && _d !== void 0 ? _d : []).includes(notification.method) && !notification.params && !(options === null || options === void 0 ? void 0 : options.relatedRequestId) && !(options === null || options === void 0 ? void 0 : options.relatedTask)) {
				...
				Promise.resolve().then(() => {
					...
					(_b = this._transport) === null || _b === void 0 || _b.send(jsonrpcNotification, options).catch((error) => this._onerror(error));
				});
				return;
			}
			let jsonrpcNotification = {
...
var import_ajv, import_dist, AjvJsonSchemaValidator;
var init_ajv_provider = require_chunk.__esmMin((() => {
	import_ajv = require_ajv();
	import_dist = /* @__PURE__ */ require_chunk.__toESM(require_dist(), 1);
...
Object.defineProperty(exports, "init_ajv_provider", {
	enumerable: true,
	get: function() {
		return init_ajv_provider;
	}
});
...
Object.defineProperty(exports, "init_zod_compat", {
	enumerable: true,
	get: function() {
		return init_zod_compat;
	}
});
Object.defineProperty(exports, "init_zod_json_schema_compat", {
	enumerable: true,
	get: function() {
		return init_zod_json_schema_compat;
	}
});
