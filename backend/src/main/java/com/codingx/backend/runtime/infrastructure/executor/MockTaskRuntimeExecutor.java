...
/**
 * Executes the runtime behavior encapsulated by MockTaskRuntimeExecutor.
 */
@Component
@Primary
...
public class MockTaskRuntimeExecutor implements TaskRuntimeExecutor {
    ...
    /**
     * Executes the logic defined by runTask.
     * @param task input argument.
     */
    ...
    /**
     * Executes the logic defined by appendEvent.
     * @param task input argument.
    ...
    /**
     * Executes the logic defined by pause.
     */
    private void pause() {
