...
VALUES
    ...
    (7053, 'ai.selection.stream_completion_timeout_ms', '300000', NULL, FALSE, NULL, NULL, NULL, 'LONG', 'ai.routing', '模型路由整流完成超时毫秒', 40, FALSE, 0),
...
-- 预置来自 GitHub 的通用热门技能；这些技能依赖 RustFS 中同名目录化包。
INSERT INTO skill (
    id,
    skill_code,
    display_name,
